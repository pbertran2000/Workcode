...
pm_df["hmean"] = pm_df["hmean"].fillna(value=1.2)
...
plt.xlabel('mes')
plt.title('Average for each month of SO2 concentration in the Eixample area during 2019 and 2020', y=1.1)
plt.legend()
plt.ylim(0,3)
plt.show()
...
plt.ylim(0,2.5)
plt.title('Annual average concentration of SO2 in the air for different areas of Barcelona', y=1.1)
